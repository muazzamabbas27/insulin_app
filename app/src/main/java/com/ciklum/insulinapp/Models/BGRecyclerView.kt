...
class BGRecyclerView constructor(beforeEvent:String,initialBG:String,targetBG:String,amountOfCHO:String,disposedCHO:String,correctionFactor:String,insulinRecommendation:String,insulinType:String)
{
    ...
    var targetBG:String=targetBG
    var amountOfCHO:String=amountOfCHO
    var disposedCHO:String=disposedCHO
    var correctionFactor:String=correctionFactor
    var insulinRecommendation:String=insulinRecommendation
    var insulinType:String=insulinType
}